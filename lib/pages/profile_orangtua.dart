...
class ProfileOrangTua extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text('Ahmad Hidayat', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              const SizedBox(height: 4),
              const Text('Orang Tua / Wali Murid • Anak di Kelas 5A', style: TextStyle(color: Colors.white70, fontSize: 13)),
            ],
          ),
        ),
      ),
  ...
  Widget _buildInfoCard() {
    return Container(
      ...
      child: Column(
        children: [
          _infoRow(Icons.email_rounded, 'Email', 'ortu@gmail.com'),
          const Divider(height: 24),
          _infoRow(Icons.phone_rounded, 'Nomor Telepon', '+62 813-1283-9999'),
          const Divider(height: 24),
          _infoRow(Icons.child_care_rounded, 'Nama Anak', 'Budi Santoso'),
        ],
      ),
    );
  }
