...
class ProfilGuru extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text('Guru Pengajar', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              const SizedBox(height: 4),
              const Text('Wali Kelas 10A • NIP. 198002131238910', style: TextStyle(color: Colors.white70, fontSize: 13)),
            ],
          ),
        ),
      ),
  ...
  Widget _buildInfoCard() {
    return Container(
      ...
      child: Column(
        children: [
          _infoRow(Icons.email_rounded, 'Email', 'guru@gmail.com'),
          const Divider(height: 24),
          _infoRow(Icons.phone_rounded, 'Nomor Telepon', '+62 812-3456-7890'),
          const Divider(height: 24),
          _infoRow(Icons.book_rounded, 'Mata Pelajaran', 'Matematika'),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SwitchListTile(
            activeColor: _primary,
            title: const Text('Laporan Mingguan via Email', style: TextStyle(fontSize: 14)),
            value: false,
            onChanged: (v) {},
          ),
        ],
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Divider(height: 1, indent: 16, endIndent: 16),
          ListTile(leading: const Icon(Icons.help_outline_rounded, color: Colors.grey), title: const Text('Bantuan & Dukungan', style: TextStyle(fontSize: 14)), trailing: const Icon(Icons.chevron_right_rounded, color: Colors.grey), onTap: () {}),
        ],
      ),
    );
  }
