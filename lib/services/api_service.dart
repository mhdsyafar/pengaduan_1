...
class ApiService {
  ...
  static Future<Map<String, dynamic>> getAllPengaduan({int page = 1, int limit = 50}) async {
    try {
      final token = await getToken();
      if (token == null) return {'success': false, 'message': 'Token tidak ditemukan'};
  ...
  /// BUAT PENGADUAN BARU
  static Future<Map<String, dynamic>> createPengaduan(String judul, String isi) async {
    try {
      final token = await getToken();
      if (token == null) return {'success': false, 'message': 'Token tidak ditemukan'};
      ...
      if (response.statusCode == 201 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal membuat pengaduan'};
      }
    } catch (e) {
  ...
  static Future<Map<String, dynamic>> updateStatusPengaduan(String idPengaduan, String status) async {
    try {
      final token = await getToken();
      if (token == null) return {'success': false, 'message': 'Token tidak ditemukan'};
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal memperbarui status'};
      }
    } catch (e) {
      return {'success': false, 'message': 'Tidak dapat terhubung ke server: $e'};
    }
  ...
  static Future<Map<String, dynamic>> getTanggapan(String idPengaduan) async {
    try {
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal mengambil tanggapan'};
      }
    } catch (e) {
      return {'success': false, 'message': 'Tidak dapat terhubung ke server: $e'};
    }
  ...
  static Future<Map<String, dynamic>> createTanggapan(String idPengaduan, String isiTanggapan) async {
    try {
      final token = await getToken();
      if (token == null) return {'success': false, 'message': 'Token tidak ditemukan'};
      ...
      if (response.statusCode == 201 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal membuat tanggapan'};
      }
    } catch (e) {
      return {'success': false, 'message': 'Tidak dapat terhubung ke server: $e'};
    }
  ...
  static Future<Map<String, dynamic>> getAllOrangtua() async {
    try {
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal mengambil data orangtua'};
      }
    } catch (e) {
  ...
  /// BUAT ORANG TUA BARU
  static Future<Map<String, dynamic>> createOrangtua(Map<String, dynamic> body) async {
    try {
      final token = await getToken();
      if (token == null) return {'success': false, 'message': 'Token tidak ditemukan'};
      ...
      if (response.statusCode == 201 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal membuat orangtua'};
      }
    } catch (e) {
      return {'success': false, 'message': 'Tidak dapat terhubung: $e'};
    }
  ...
  /// UPDATE ORANG TUA
  static Future<Map<String, dynamic>> updateOrangtua(int id, Map<String, dynamic> body) async {
    try {
      final token = await getToken();
      if (token == null) return {'success': false, 'message': 'Token tidak ditemukan'};
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal update orangtua'};
      }
    } catch (e) {
      return {'success': false, 'message': 'Tidak dapat terhubung: $e'};
    }
  ...
  static Future<Map<String, dynamic>> deleteOrangtua(int id) async {
    try {
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal menghapus orangtua'};
      }
    } catch (e) {
      return {'success': false, 'message': 'Tidak dapat terhubung: $e'};
    }
  ...
  static Future<Map<String, dynamic>> getAllSiswa() async {
    try {
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal mengambil data siswa'};
      }
    } catch (e) {
      return {'success': false, 'message': 'Tidak dapat terhubung: $e'};
    }
  ...
  static Future<Map<String, dynamic>> createUser(Map<String, dynamic> body) async {
    try {
      ...
      if ((response.statusCode == 201 || response.statusCode == 200) && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal membuat user'};
      }
    } catch (e) {
      return {'success': false, 'message': 'Tidak dapat terhubung: $e'};
    }
  ...
  static Future<Map<String, dynamic>> updateUser(int id, Map<String, dynamic> body) async {
    try {
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        return {'success': false, 'message': data['message'] ?? 'Gagal update user'};
      }
    } catch (e) {
      return {'success': false, 'message': 'Tidak dapat terhubung: $e'};
    }
